 ...
 * 
 * 使用方法：在loader里加上 baseAttrs:{uiProvider:Ext.ux.tree.TreeCheckNodeUI} 既可.
 * 例如：
 ...
 * 
 * @author  韦海晗
 * @class Ext.ux.tree.TreeCheckNodeUI
 * @extends Ext.tree.TreeNodeUI
 */
Ext.namespace('Ext.ux.tree.TreeCheckNodeUI');
Ext.ux.tree.TreeCheckNodeUI = function() {
	Ext.ux.tree.TreeCheckNodeUI.superclass.constructor.apply(this, arguments);
};

Ext.extend(Ext.ux.tree.TreeCheckNodeUI, Ext.tree.TreeNodeUI, {
	/*
	* 多选: 'multiple'(默认)
	* 单选: 'single'
	* 级联多选: 
